          ...
          <section id="components-section-data-processes-page" className="">
            <article className="mx-auto px-12 ">
              ...
              <ul className="grid grid-rows-9  md:11/12 lg:w-full md:grid-rows-5 md:grid-cols-2 md:gap-16 lg:gap-5 lg:flex lg:justify-around flex-wrap lg:mx-auto ">
                <li className=" z-10 text-center grid-rows-2 lg:w-56">
                  ...
                  <div className="h-40 flex flex-col justify-content-center text-center italic lg:text-md px-6 dialog-section bg-main-color bg-blue-300 font-semibold border-2 border-white rounded-lg">
                ...
                <li className=" z-10 text-center grid-rows-2 lg:w-56">
                  ...
                  <div className="h-40 flex flex-col justify-content-center text-center italic lg:text-md px-6 dialog-section bg-main-color bg-blue-300 font-semibold border-2 border-white rounded-lg">
                    ...
                    to use? Who will use the data and how?
                  </div>
                </li>
                <li className=" z-10 text-center grid-rows-2 lg:w-56">
                  <div className="w-10/12 h-56 mx-auto mb-0 data-gov-component bg-white font-bold shadow-2xl rounded-lg p-4 my-6 block text-center">
            ...
            <article className="px-16  my-20 from-current">
              ...
              <div
                ...
                className="grid grids-cols-1  justify-items-center items-center gap-4 md:grid-cols-1 md:px-40 md:gap-7 lg:grid-cols-7 lg:gap-2 lg:grid-rows-1"
              >
                ...
                <div className="h-full  flex flex-col shadow-2xl rounded-lg border-2 border-white w-full">
                  ...
                  <div className="h-3/6 bg-yellow-cream pt-2 pt-1 flex flex-col items-center justify-items-center">
                    <Image
                      width={40}
                      height={45}
                ...
                <div className="h-full flex flex-col shadow-2xl rounded-lg border-2 border-white w-full">
                  ...
                  <div className="h-3/6 bg-yellow-cream pt-2  flex flex-col items-center justify-items-center">
                    ...
                    <p className="p-3 text-sm  font-semibold text-center">
                      {" "}
                      Internally (for strategic planning) To funders To
                      community
                    </p>
                  </div>
                </div>
                ...
                <div className="h-full flex flex-col shadow-2xl rounded-lg border-2 border-white w-full">
                  ...
                  <div className="h-3/6 bg-yellow-cream pt-2 pt-2 flex flex-col items-center justify-items-center">
            ...
            <div
              className="fundation-bottom-container grid grid-cols-1 md:grid-cols-4 bg-white rounded-xl
           shadow-lg p-3 gap-5 justify-items-center items-center mx-16 mb-16"
            >
              <div className="p-3">
                <h6 className="font-bold">Fundation</h6>
                <p className="text-sm">
                  Data policy, program logic model and workflow and persona maps
                </p>
              </div>
